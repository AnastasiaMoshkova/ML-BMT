Семинары и лабораторыне работы по первой части курса посвящены практичесокму изучению методов выделения признаков, а вторая часть посвящена алгоритмам машинного изучения и их примненеию на python.
